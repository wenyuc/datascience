...
# first attempt is to use linear regression and find the best model:
# paid_account = beta_0 (* 1) + beta_1 * experience + beta_2 * salary + epsilon 
...
from datascience.linear_algebra import vector_sum
